...
private:
    ...
    std::string itFirstNameB[383] = { };
    // Array Containing Male Italian Given Name
    std::string itFirstNameG[198] = { };
    // Array Containing Female Italian Given Name
    std::string itFamilyName[791] = { };

    std::string swFirstNameB[198] = { };
    // Array Containing Male Swedish Given Name
    std::string swFirstNameG[178] = { };
    // Array Containing Female Swedish Given Name
